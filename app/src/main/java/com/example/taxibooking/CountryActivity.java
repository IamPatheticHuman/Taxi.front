...
public class CountryActivity extends AppCompatActivity {
    ...
    String[] arrayone =  {"Kyrgyzstan", "Australia", "Canada", "England", "Japan", "India"};
    Integer [] arraytwo = {R.drawable.kg, R.drawable.aus, R.drawable.can, R.drawable.eng, R.drawable.jap, R.drawable.ind};
